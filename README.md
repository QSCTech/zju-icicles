...
仓库越来越大，如果只需要下载某个文件夹时（某个课程），可参考以下方法：

1. 点击：https://github.dev/QSCTech/zju-icicles，进入仓库的在线VSCode环境
（参考资料：https://docs.github.com/zh/codespaces/the-githubdev-web-based-editor#%E6%89%93%E5%BC%80-githubdev-%E7%BC%96%E8%BE%91%E5%99%A8）
2. 在左侧文件树找到目标文件夹/选择多个文件 → 右键 → 选择 下载
3. 浏览器会自动弹出窗口，选择保存位置即可
